...
Use=================
I put the final in my /bin folder and gave it a short name so I coudld run it with "alt+F2" which brought up my 'run program' so I could quickly shuffle it. 
